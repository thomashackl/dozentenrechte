...
class Dozentenrecht extends SimpleORMap {
    ...
    private function notify() {
        if (!$this->notify) {
            ...
            PersonalNotifications::add($this->for_id, PluginEngine::GetURL($this, array(), 'show'), $message);
            ...
            PersonalNotifications::add($this->from_id, PluginEngine::GetURL($this, array(), 'show/given'), $message);
